...
>
    <img src={Logo} alt="Logo" style={{ width: '300px', marginBottom: '16px' }} />
    ...
    <TextField
      ...
      sx={{
        ...
        '&:hover .MuiOutlinedInput-root .MuiOutlinedInput-notchedOutline': { borderColor: '#fff' },
      }}
    />
    <TextField
    ...
    <Button sx={{   
        backgroundColor: '#233054',
            ...
            mt: 2
          }} variant="contained" color="primary" fullWidth onClick={handleLogin}>
